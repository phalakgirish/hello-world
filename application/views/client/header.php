	...
	<body onload="startTime()">
			...
			<div class="container ">
				<div class="navbar-header logo_head">
					<a class="navbar-brand" href="<?php echo base_url()?>client/welcome/index"><span><img src="<?php echo base_url()?>assets/client/img/logo.png" class="img-responsive"></span></a>
				</div>
				<div id="navbar" class="navbar-collapse collapse nav_menu">
					<ul class="nav navbar-nav">
						...
						<li><a href="#"><i class="fas fa-book"></i> Study Mode</a></li>
						<?php
							$streamlist=$this->myclass->select("stream_id,stream_name,stream_status","stream","stream_status='Active'");
							foreach ($streamlist as $list)
							{
								# code...
						?>
						<li><a href="<?php echo base_url();?>client/welcome/stream/<?php echo $list->stream_id;?>"><i class="fab fa-first-order"></i> <?php echo $list->stream_name ?></a></li>
