        ...
        <div class="container">
            <div class="pull-right col-md-12">
                <div class="login-bg">
                    ...
                    ?>              
                        <li><a href="<?php echo base_url()?>client/welcome/login"><span class="top-icon login-icon">Login</span></a></li>
                    ...
                    <li><a href="<?php echo base_url()?>client/welcome/do_logout"><span class="top-icon login-icon">Logout</span></a></li>
                    <?php
                    endif;
                    ?> 
                    </ul>
            ...
            <div class="col-md-10" > 
                <div class="social-icon pull-right">
                    <ul class="">   
                        ...
                        <li><a href="#"><img src="<?php echo base_url().'assets/client/'?>images/insta.png" /></a></li>
                    </ul>
                </div>
